...
import android.copy.SparseIntArray;
...
final class ColorCutQuantizer {
    ...
    /**
     * Factory-method to generate a {@link android.support.v7.graphics.ColorCutQuantizer} from a {@link java.awt.image.BufferedImage} object.
     *
     * @param bitmap    Bitmap to extract the pixel data from
     * @param maxColors The maximum number of colors that should be in the result palette.
     */
    static ColorCutQuantizer fromBitmap(BufferedImage bitmap, int maxColors) {
        final int width = bitmap.getWidth();
        final int height = bitmap.getHeight();

        final int[] pixels = ((DataBufferInt) bitmap.getRaster().getDataBuffer()).getData();
     ...
     * {@link android.support.v7.graphics.ColorCutQuantizer.Vbox} objects from the queue
     ...
     *
     * @see android.support.v7.graphics.ColorCutQuantizer.Vbox#findSplitPoint()
     */
    ...
    /**
     * Comparator which sorts {@link android.support.v7.graphics.ColorCutQuantizer.Vbox} instances based on their volume, in descending order
     */
