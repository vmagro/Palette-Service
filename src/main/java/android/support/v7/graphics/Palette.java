 ...
 * <p/>
 * <p/>
 * Instances can be created with the synchronous factory methods {@link #generate(java.awt.image.BufferedImage)} and
 * {@link #generate(java.awt.image.BufferedImage, int)}.
 * <p/>
 * <pre>
 * android.support.v7.graphics.Palette.generateAsync(bitmap, new android.support.v7.graphics.Palette.PaletteAsyncListener() {
...
public final class Palette {
    ...
    /**
     * Generate a {@link android.support.v7.graphics.Palette} from a {@link java.awt.image.BufferedImage} using the default number of colors.
     */
    ...
    /**
     * Generate a {@link android.support.v7.graphics.Palette} from a {@link java.awt.image.BufferedImage} using the specified {@code numColors}.
    ...
    public static Palette generate(BufferedImage bitmap, int numColors) {
        ...
        final BufferedImage scaledBitmap = scaleBitmapDown(bitmap);
    ...
    /**
     * Find the {@link android.support.v7.graphics.Palette.Swatch} with the highest population value and return the population.
     */
     ...
     * is returned.
     */
    private static BufferedImage scaleBitmapDown(BufferedImage bitmap) {
        ...
        Image image = bitmap.getScaledInstance(Math.round(bitmap.getWidth() * scaleRatio),
                Math.round(bitmap.getHeight() * scaleRatio), Image.SCALE_FAST);
    ...
    /**
     * Copy a {@link android.support.v7.graphics.Palette.Swatch}'s HSL values into a new float[].
     */
    ...
    public static final class Swatch {
         ...
         * {@link android.support.v7.graphics.Palette.Swatch}'s color. This color is guaranteed to have sufficient contrast.
         */
